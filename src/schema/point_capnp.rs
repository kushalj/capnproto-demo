...
pub mod point {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xc197_24ad_fa49_7ad7;
  }
}
...
pub mod point_tracker {
  ...
  pub type AddPointParams<> = ::capnp::capability::Params<crate::server::point_capnp::point_tracker::add_point_params::Owned>;
  pub type AddPointResults<> = ::capnp::capability::Results<crate::server::point_capnp::point_tracker::add_point_results::Owned>;
  ...
  impl  Client {
    pub fn add_point_request(&self) -> ::capnp::capability::Request<crate::server::point_capnp::point_tracker::add_point_params::Owned,crate::server::point_capnp::point_tracker::add_point_results::Owned> {
      self.client.new_call(_private::TYPE_ID, 0, None)
    }
  }
  pub trait Server<>   {
    fn add_point(&mut self, _: AddPointParams<>, _: AddPointResults<>) -> ::capnp::capability::Promise<(), ::capnp::Error> { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("method not implemented".to_string())) }
  }
  ...
  pub mod _private {
    pub const TYPE_ID: u64 = 0xc88e_a039_72e5_2e24;
  }
  ...
  pub mod add_point_params {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_p(self) -> ::capnp::Result<crate::server::point_capnp::point::Reader<'a>> {
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn get_p(self) -> ::capnp::Result<crate::server::point_capnp::point::Builder<'a>> {
        ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
      }
      #[inline]
      pub fn set_p(&mut self, value: crate::server::point_capnp::point::Reader<'_>) -> ::capnp::Result<()> {
        ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value, false)
      }
      #[inline]
      pub fn init_p(self, ) -> crate::server::point_capnp::point::Builder<'a> {
    ...
    impl Pipeline  {
      pub fn get_p(&self) -> crate::server::point_capnp::point::Pipeline {
    ...
    mod _private {
      ...
      pub const TYPE_ID: u64 = 0x832c_06ed_59e1_4849;
    }
  }
  ...
  pub mod add_point_results {
    ...
    mod _private {
      use capnp::private::layout;
      pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 1, pointers: 0 };
      pub const TYPE_ID: u64 = 0xbb69_058f_df7d_2f4d;
    }
  }
}
